...
const Window = ({ title, children, open, isContentCentered, actions, headerButtons, headerComponent, onClose }) => {
    return <Modal
        centered={true}
        className='Window'
        open={open}
    ...
    >
        <Modal.Header>
            ...
            {headerComponent ? <span className='WindowHeaderComponent'>{headerComponent}</span> : null}
        </Modal.Header>
